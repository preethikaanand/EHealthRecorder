...
public class DoctorProfileActivity extends BaseActivity {
    ...
    private DoctorDataFragment doctorDataFragment;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view_shadow_toolbar = (View) findViewById(R.id.docProfile_toolbar_shadow);
        ...
        mContentFrame = (FrameLayout) findViewById(R.id.docProfile_contentframe);
        ...
        if (savedInstanceState == null) {
            ...
            doctorDataFragment = (DoctorDataFragment) getSupportFragmentManager().getFragments().get(0);
        }
    }

    private void setUpToolbar() {
        mToolbar = (Toolbar) findViewById(R.id.docProfile_toolbar);
        if (mToolbar != null) {
    ...
    protected void showFragmentView(int position) {
        ...
        switch (position) {
            case 0:
                ...
                doctorDataFragment = new DoctorDataFragment();
                break;
            default:
                break;
        }
        ...
        if (doctorDataFragment != null) {
            ...
            fragmentTransaction.replace(R.id.docProfile_contentframe, doctorDataFragment);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.doctor_overflow_menu, menu);
    ...
    public void onBackPressed() {
        ...
        if (!doctorDataFragment.onBackPressed()) {
